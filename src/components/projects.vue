  ...
  <div class="shoeGif">
    ...
    <div class="newGif">
      ...
      <div class="tech">
        ...
        <p>A collaborative group project implementing React Native, Clarafi image recognition and Amazon Web Services S3 image hosting. My role in this project was helping to set up the back-end Express server, create the Knex database as well as help post the images taken from the iPhone’s native camera to an S3 bucket. Fridgely was created with the intent to scan an item in your fridge, take a photo and send it off to the image recognition API and then return a list of recipes based on the food item that was scanned.</p>
